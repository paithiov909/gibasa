...
#'
#' The UTF-8 plain text is sourced from \url{https://www.aozora.gr.jp/cards/000081/card43737.html} and is cleaned of meta data.
#'
#' @source \url{https://www.aozora.gr.jp/cards/000081/files/43737_ruby_19028.zip}
#' @examples
#' head(ginga)
"ginga"
