...
const char *getGlobalError() { return kErrorBuffer; }
...
const char *mecab_version() { return MeCab::Tagger::version(); }
...
char *mecab_sparse_tostr3(mecab_t *tagger, const char *str, size_t len,
  ...
  return const_cast<char *>(
      reinterpret_cast<MeCab::Tagger *>(tagger)->parse(str, len, out, len2));
}
...
const mecab_node_t *mecab_sparse_tonode2(mecab_t *tagger, const char *str,
                                         size_t len) {
  return reinterpret_cast<const mecab_node_t *>(
...
char *mecab_nbest_sparse_tostr3(mecab_t *tagger, size_t N, const char *str,
                                size_t len, char *out, size_t len2) {
  return const_cast<char *>(
      reinterpret_cast<MeCab::Tagger *>(tagger)->parseNBest(N, str, len, out,
                                                            len2));
}
...
void mecab_lattice_set_sentence2(mecab_lattice_t *lattice, const char *sentence,
                                 size_t len) {
...
int mecab_lattice_has_request_type(mecab_lattice_t *lattice, int request_type) {
  return reinterpret_cast<MeCab::Lattice *>(lattice)->has_request_type(
      request_type);
}
...
void mecab_lattice_remove_request_type(mecab_lattice_t *lattice,
                                       int request_type) {
  return reinterpret_cast<MeCab::Lattice *>(lattice)->remove_request_type(
      request_type);
}
...
const char *mecab_lattice_tostr2(mecab_lattice_t *lattice, char *buf,
                                 size_t size) {
...
const char *mecab_lattice_nbest_tostr2(mecab_lattice_t *lattice, size_t N,
                                       char *buf, size_t size) {
  return reinterpret_cast<MeCab::Lattice *>(lattice)->enumNBestAsString(N, buf,
                                                                        size);
}

int mecab_lattice_has_constraint(mecab_lattice_t *lattice) {
  return static_cast<bool>(
      reinterpret_cast<MeCab::Lattice *>(lattice)->has_constraint());
}
...
void mecab_lattice_set_boundary_constraint(mecab_lattice_t *lattice, size_t pos,
                                           int boundary_type) {
  return reinterpret_cast<MeCab::Lattice *>(lattice)->set_boundary_constraint(
      pos, boundary_type);
}
...
void mecab_lattice_set_feature_constraint(mecab_lattice_t *lattice,
                                          ...
                                          const char *feature) {
  return reinterpret_cast<MeCab::Lattice *>(lattice)->set_feature_constraint(
      begin_pos, end_pos, feature);
}
...
int mecab_model_swap(mecab_model_t *model, mecab_model_t *new_model) {
  return static_cast<int>(reinterpret_cast<MeCab::Model *>(model)->swap(
...
int mecab_model_transition_cost(mecab_model_t *model, unsigned short rcAttr,
                                unsigned short lcAttr) {
  return reinterpret_cast<MeCab::Model *>(model)->transition_cost(rcAttr,
                                                                  lcAttr);
}

mecab_node_t *mecab_model_lookup(mecab_model_t *model, const char *begin,
                                 const char *end, mecab_lattice_t *lattice) {
  return reinterpret_cast<mecab_node_t *>(
      reinterpret_cast<MeCab::Model *>(model)->lookup(
          begin, end, reinterpret_cast<MeCab::Lattice *>(lattice)));
}
