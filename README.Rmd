...
Gibasa is a plain 'Rcpp' wrapper of 'MeCab', a CJK (Chinese, Japanese, and Korean) tokenizer and morphological analysis tool for R.
...
You can install binary package via [r-universe](https://paithiov909.r-universe.dev/gibasa).
