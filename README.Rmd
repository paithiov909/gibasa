...
In case using Linux or Mac OSX, you can install that via their package managers, or build and install from the source by yourself.

In case using Windows, launch msys2 console of the rtools, then install MeCab and its dictionary via pacman before your installing package (currently being tested on rtools42).
