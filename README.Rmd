...
In case using Windows, launch msys2 console of the rtools, then install MeCab and its dictionary with pacman before your installing package (currently being tested on [rtools42](https://cran.r-project.org/bin/windows/Rtools/rtools42/rtools.html)).
