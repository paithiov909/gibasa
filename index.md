...
may therefore split text into incorrect tokens.
...
- [`gibasa::prettify()`](https://paithiov909.github.io/gibasa/reference/prettify.md)
  — expand MeCab feature strings into columns
- [`gibasa::pack()`](https://paithiov909.github.io/gibasa/reference/pack.md)
  — reconstruct whitespace-separated text

![flowchart of a text analysis that combines gibasa and other
packages](reference/figures/tidytext_fig5_1_mod.drawio.png)
...
converts a TIF-compliant data frame into tidy token data so that it can
be used as a drop-in alternative to
...
parses the feature string returned by MeCab and splits it into
structured columns.

[`pack()`](https://paithiov909.github.io/gibasa/reference/pack.md)
performs the reverse transformation and reconstructs a
