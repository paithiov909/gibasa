...
for CJK text data. For this goal, gibasa provides three main functions:
...
- [`gibasa::tokenize`](https://paithiov909.github.io/gibasa/reference/tokenize.md)
  takes a TIF-compliant data.frame of corpus, returning tokens as format
  that known as ‘tidy text data’, so that users can replace
  [`tidytext::unnest_tokens`](https://juliasilge.github.io/tidytext/reference/unnest_tokens.html)
