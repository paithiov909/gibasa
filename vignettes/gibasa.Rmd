...
[r-universe](https://paithiov909.r-universe.dev/ui#package:gibasa)からインストールできます。
...
Windowsの場合、ソースビルドには[Rtools42](https://cran.r-project.org/bin/windows/Rtools/rtools42/rtools.html)が必要です。また、インストールの方法によらず、gibasaを使用するにはMeCabの辞書が必要なため、[これ](https://github.com/ikegami-yukino/mecab/releases/tag/v0.996.2)などを使ってMeCabをインストールしておいてください。
